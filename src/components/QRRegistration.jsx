    ...
    <div className="bg-slate-900 select-none relative w-full">
      {!successClient ? (
        ...
        <div className="p-8 space-y-6 text-center">
          ...
          <div className="bg-white text-slate-950 p-6 rounded-2xl max-w-sm mx-auto shadow-2xl border border-slate-200 relative select-text text-left animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* ID Background Image */}
            <img 
              src="img/id.png" 
              className="absolute inset-0 w-full h-full object-cover pointer-events-none rounded-2xl"
            />
            <div className="absolute top-2 right-3 font-mono text-[7px] text-slate-400 tracking-wider">
            ...
            <div className="space-y-1.5 font-sans border-t border-slate-200/50 pt-3">
              <div className="flex items-center gap-1.5">
                <span className="text-[8px] font-mono text-slate-500 w-20 shrink-0 uppercase">LAST NAME:</span>
                <span className="text-[10px] font-black text-slate-900 uppercase truncate">
                  <span className="text-blue-600">▶</span> {successClient.lastName}
                </span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="text-[8px] font-mono text-slate-500 w-20 shrink-0 uppercase">FIRST NAME:</span>
                <span className="text-[10px] font-black text-slate-900 uppercase truncate">
                  <span className="text-blue-600">▶</span> {successClient.givenName}
                </span>
              </div>
              <div className="flex items-center gap-1.5">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-sm mx-auto pt-4">
            ...
            <button type="button" onClick={onBackToScanner} className="flex-1 py-2.5 bg-slate-800 hover:bg-slate-750 text-slate-200 font-mono font-bold text-[10.5px] uppercase rounded-lg flex items-center justify-center gap-1">
